...
DAYS = [
    {
        ...
        'stats': [('機車', '50 分', '每段 15 分內'), ('兩人花費', '約 3,530', '含住宿、已扣補助'), ('住宿補助', '−800', '你的第 1 晚')],
        'rows': [
    ...
    },
    {
        ...
        'chips': [('新竹', 'hc')],
        'route': '北埔老街 → 水井茶堂 → 峨眉湖',
        'stats': [('機車', '1 時 55 分', '每段 25 分內・休息 2 次'), ('兩人花費', '約 2,180', '含住宿、已扣補助'), ('住宿補助', '−1,200', '你的第 2 晚')],
        'rows': [
    ...
    },
    {
        ...
        'stats': [('機車', '35 分', '每段 8 分內'), ('兩人花費', '約 5,120', '含住宿、已扣補助'), ('住宿補助', '−800', '媽媽的第 1 晚')],
        'rows': [
    ...
    },
    {
        ...
        'stats': [('機車', '2 時 15 分', '每段 27 分內・休息 2 次'), ('兩人花費', '約 4,780', '含住宿、已扣補助'), ('住宿補助', '−1,200', '媽媽的第 2 晚')],
        'rows': [
    ...
    },
    {
        ...
        'checks': ['125 次是全趟最急的票，今天就訂', '買冷凍水晶餃，請店家加保冷袋', '125 次沒位改 129 次 15:38，16:30 到，都在 17:00 前'],
    },
]
